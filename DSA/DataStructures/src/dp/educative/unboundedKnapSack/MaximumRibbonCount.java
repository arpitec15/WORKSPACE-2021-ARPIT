...
public class MaximumRibbonCount {
	...
	public int countRibbonPieces(int[] ribbonLengths, int total) {
		int maxPieces = countRibbonPiecesRecursive(ribbonLengths, total, 0);
	...
	private int countRibbonPiecesRecursive(int[] ribbonLengths, int total, int currentIndex) {
		...
		// if the ribbon length at the currentIndex exceeds the total, we shouldn't
		// process this
	...
	private static int countRibbonPiecesDP(int[] ribbonLengths, int total) {
...
//		System.out.println(cr.countRibbonPieces(ribbonLengths, 5));
		...
		int out = countRibbonPiecesDP(ribbonLengths, 5);
